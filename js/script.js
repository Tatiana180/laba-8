...
let firstTeamDesigner1 = new Designer('Данил', "Василенко", 1500, 3, 0.2);
let firstTeamDesigner2 = new Designer('Олександра', "Авдеева", 2500, 3, 0.777777);
let firstTeamDeveloper1 = new Developer('Божен', "Комзюк", 2900, 1);
let firstTeamManager = new Manager('Устим', "Драгомирецький", 2000, 2, [firstTeamDesigner1, firstTeamDesigner2, firstTeamDeveloper1]);

let secondTeamDesigner1 = new Designer('Златомир', "Купчишин", 3500, 3, 0.5);
let secondTeamDeveloper1 = new Developer('Маркіян', "Гуляницький", 1500, 0);
let secondTeamDeveloper2 = new Developer('Злотан', "Лагода", 2000, 6);
let secondTeamManager = new Manager('Юрій', "Юзефович", 2500, 4, [secondTeamDesigner1, secondTeamDeveloper1, secondTeamDeveloper2]);
